          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                ...
                <input type="password" name="password" id="" class="form-control form-control-sm" value=""minlength="6" maxlength="16" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Password Must contain at least one number and one uppercase and lowercase letter, and at least 6 characters."<?php echo isset($id) ? '' : 'required' ?>>
